const projects = [
  ...
  },
  {
   ...
   2. Utilizes the Rapid API to access real-time data from YouTube.
   3. Implements styling with the help of Tailwind CSS for a modern and responsive design.
   4.  Manages the state of the application efficiently using the React Context API.
   5.  Ensures responsiveness across various devices, providing a consistent user experience
   `,
    projectLink: "https://youtube-clone-by-ashok.netlify.app/",
    projectCodeLink: "https://github.com/Ashoka2002/Youtube-Clone",
  ...
  },
  {
    ...
    making it highly organized and scalable with classes.
    Enjoy the freedom to add your unique recipes,
    discover random recipes, and conveniently bookmark
    your favorites. Plus, have complete control over serving
    sizes for a truly personalized culinary experience.
    NOTE:This site is not responsive for small devices.
    `,
    projectLink: "https://forkify-by-ashok.netlify.app/",
    projectCodeLink: "https://github.com/Ashoka2002/forkify",
...
//////Skill Section//
const skills = [
  { skillName: "HTML", skillPercent: 74 },
